...
FROM SUBMISSIONS S WHERE S.SUBMISSION_DATE = S1.SUBMISSION_DATE AND 
(SELECT COUNT (DISTINCT  SS.SUBMISSION_DATE) FROM SUBMISSIONS SS WHERE SS.HACKER_ID = S.HACKER_ID) )
